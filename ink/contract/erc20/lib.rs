// Modified by avcdsld
// Original code: Parity Technologies (UK) Ltd.
//
...
mod erc20 {
    ...
    #[ink(event)]
    pub struct Transfer { #[ink(topic)] from: Option<AccountId>, #[ink(topic)] to: Option<AccountId>, #[ink(topic)] value: Balance }

    #[ink(event)]
    pub struct Approval { #[ink(topic)] owner: AccountId, #[ink(topic)] spender: AccountId, #[ink(topic)] value: Balance }
    ...
    impl Erc20 {
        ...
        pub fn new(initial_supply: Balance) -> Self {
            ...
            let instance = Self { total_supply: Lazy::new(initial_supply), balances: [(caller, initial_supply)].iter().cloned().collect(), allowances: HashMap::new() };
